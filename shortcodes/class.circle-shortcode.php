...
var lat = <?php echo esc_html( $lat ); ?>;
var lng = <?php echo esc_html( $lng ); ?>;
var radius = <?php echo esc_html( $radius ); ?>;
...
circle.setStyle(<?php echo $style_json;  //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>);
circle.addTo( group );
