...
class Leaflet_Image_Overlay_Shortcode extends Leaflet_Shortcode {
	...
	protected function getHTML( $atts = '', $content = null ) {
		...
		?>/*<script>*/
			...
			var src = '<?php echo esc_html( $url, ENT_QUOTES ); ?>';
			var options = <?php echo $options; //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>;
			var bounds = <?php echo wp_json_encode( $bounds ); ?>;
			var layer = <?php echo esc_html( $this->type ); ?>(src, bounds, options);
			layer.addTo(group);
