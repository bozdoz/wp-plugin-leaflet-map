...
class Leaflet_Wms_Shortcode extends Leaflet_Map_Shortcode {
	...
	protected function getHTML( $atts = '', $content = null ) {
		...
		ob_start();
		?>/*<script>*/
var srcUrl = atob('<?php echo base64_encode( $source ); //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped, WordPress.PHP.DiscouragedPHPFunctions.obfuscation_base64_encode ?>');
...
var map = window.WPLeafletMapPlugin.createMap(options).setView(L.latLng(<?php echo esc_html( $lat ); ?>, <?php echo esc_html( $lng ); ?>), zoom);
