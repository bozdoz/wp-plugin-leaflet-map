...
<h1><?php echo esc_html( $plugin_title ); ?> <small>version: <?php echo esc_html( $version ); ?></small></h1>
...
if ( $is_unpkg_url && $db_js_url !== $settings->options['js_url']->default ) {
	...
	<div class="notice notice-info is-dismissible">
		...
		echo esc_html( Leaflet_Map::$leaflet_version );
		?>
		</p>
	</div>
	<?php
...
<div class="wrap">
	...
	<div class="container">
		...
		if ( $option->helptext ) {
			?>
		<div class="helptext">
			<p class="description"><?php echo $option->helptext; //phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
		</div>
			<?php
		}
		?>
